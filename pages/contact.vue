...
<script>
import IconPhone from "~/components/icons/contact/IconPhone";
import IconLocation from "~/components/icons/contact/IconLocation";
...
import IconUser from "~/components/icons/ui/IconUser";
export default {
  components: {
    IconInsta,
    IconFacebook,
