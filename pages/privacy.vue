    ...
    <div class="text-xl px-3 text-center font-charter">
      ...
      <div class="text-left pb-6">
        <p>
          ...
          from spammers. We had created this privacy page so that users can
          better know about the information we collect and why do we collect
          them.
        </p>
        ...
        <p>
          ...
          to the user's device to identify browsers. These text files help in
          delivering you relevant content and hence a better browsing
          experience. Cookies don't harm your device in any manner as they are
          generated with the sole intention of better content and ad delivery.
          Please note that Appdodo.Com automatically erases all the cookies
          every 24 hours.
        </p>
        <br />
        ...
        <p>
          ...
          Service Provider (ISP), Web Browser. Log File may also include the
        ...
        <p>
          ...
          providing them cached version for faster page load.
        </p>
