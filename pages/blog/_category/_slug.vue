<template>
  <article class="container m-auto">
    <nuxt-content
      :document="article"
      class="blog-part w-full md:px-14"
    />
  </article>
</template>
...
export default {
  async asyncData({ $content, params }) {
    const article = await $content("blog", params.category, params.slug).fetch();
    return {
      article,
    };
  },
...
.blog-part p {
  @apply text-gray-900 text-xl font-normal md:font-serif py-2 leading-8 px-3;
}
.blog-part img{
  @apply w-full
}
